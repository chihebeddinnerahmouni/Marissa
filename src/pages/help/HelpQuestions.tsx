...
const HelpQuestions = () => {
  ...
  const { selectedCategory } = useContext(HelpContext);
  ...
  return (
    <div className="w-full px-4 mt-[85px] md:px-20 lg:mt-[90px] lg:px-[120px]">
      ...
      <div className="content w-full grid grid-cols-1 lg:grid-cols-12 lg:gap-20 lg:items-start">
        <ArticleInThisSection category={category} questions={questions} />
