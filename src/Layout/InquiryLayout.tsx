      ...
      >
        <div className="top w-full flex items-center justify-between gap-6 mb-10">
          ...
          <div className="progress bg-lightGrey flex-grow h-1.5 rounded-40 relative">
            <div className="progress-bar w-[20%] bg-primary h-full bg-main rounded-40"></div>
          </div>
          <button>
        ...
        {/* <InquiryContext.Provider value={{ isCalendarOpen, setIsCalendarOpen }}> */}
          {children}
...
//          ${
          // isCalendarOpen ? "md:h-[600px]" : "md:h-auto"
          // }