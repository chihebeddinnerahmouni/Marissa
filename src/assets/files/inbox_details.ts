const details = {
  ...
  userName: "Jenna Doea",
  boatName: "Luxurious, High demand",
  boatPic:
  ...
  duration: "8 hours",
  guests: 5,
  specialRequest: "Nothing special, thank you.",
  messages: [
    {
      id: 1,
      message:
        "Hi Captain, Please create an offer for me based on the details below. WITH CAPTAIN A captain is included in the price or otherwise arranged to host and operate the trip.CHIHEB'S PREFERRED DATE Depart: Saturday Oct 26, 2024 Return: Saturday Oct 26, 2024 Duration: 1 hour TIME Pick up time: 9 a.m. Drop off time: 10 a.m. GROU Number: 1 Ages: 1 Adult SPECIAL REQUEST u",
      date: "21 Oct 2024",
      time: "23:15",
      sender: "user",
